...
build_graphics_scene_tab :: proc() -> qt.Widget {
	...
	triangle_poly := qt.polygon_f_create()
	qt.polygon_f_append(triangle_poly, 0, 0)
	qt.polygon_f_append(triangle_poly, 60, -80)
	qt.polygon_f_append(triangle_poly, 120, 0)
	polygon_item := qt.graphics_polygon_item_create(triangle_poly, nil)
	poly_pen := qt.pen_create_with_colour(20, 100, 60, 255)
	qt.pen_set_width(poly_pen, 2)
	poly_brush := qt.brush_create_with_colour(80, 200, 120, 180)
	qt.graphics_polygon_item_set_pen(polygon_item, poly_pen)
	qt.graphics_polygon_item_set_brush(polygon_item, poly_brush)
	qt.graphics_scene_add_item(scene, auto_cast polygon_item)
	qt.graphics_item_set_pos(auto_cast polygon_item, 180, 200)
	qt.graphics_item_set_flag(auto_cast polygon_item, .Is_Movable, 1)
	qt.graphics_item_set_flag(auto_cast polygon_item, .Is_Selectable, 1)
	qt.graphics_item_set_tool_tip(auto_cast polygon_item, "QGraphicsPolygonItem")
	qt.polygon_f_destroy(triangle_poly)
	qt.pen_destroy(poly_pen)
	qt.brush_destroy(poly_brush)

	// QGraphicsSimpleTextItem — lightweight plain text
	simple_text := qt.graphics_simple_text_item_create("Simple Text", nil)
	st_brush := qt.brush_create_with_colour(80, 40, 120, 255)
	qt.graphics_simple_text_item_set_brush(simple_text, st_brush)
	st_font := qt.font_create("Segoe UI", 12, cast(c.int)qt.Font_Weight.Bold, 0)
	qt.graphics_simple_text_item_set_font(simple_text, st_font)
